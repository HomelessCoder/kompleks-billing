...
final readonly class Handler
{
    ...
    public function __invoke(Query $query): ?AccountWithVgroupsAndAgreements
    {
        ...
        $agreements = $this->agreementRepository->getAgreementsByAccountUid($query->uid, $query->operatorId);

        return new AccountWithVgroupsAndAgreements(
            $account,
            $vgroups,
            $agreements,
        );
